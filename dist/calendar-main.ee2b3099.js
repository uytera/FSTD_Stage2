...
$(document).ready(function () {
  ...
  while (startDay < lastDateOfCurrMonth) {
    if (startDay.getMonth() != month) html += '<div class="day other-month-day" data-year=' + startDay.getFullYear() + ' data-month=' + startDay.getMonth() + '>' + startDay.getDate() + '</div>';else html += '<div class="day curr-month-day" data-year=' + startDay.getFullYear() + ' data-month=' + startDay.getMonth() + '>' + startDay.getDate() + '</div>';
